...
export const CLEARED_CART_REQUEST = "CLEARED_CART_REQUEST";
export const CLEARED_CART_SUCCESS = "CLEARED_CART_SUCCESS";
export const CLEARED_CART_FAILURE = "CLEARED_CART_FAILURE";
