...
export const UPDATE_MENU_ITEM_FAILURE = "SEARCH_MENU_ITEM_FAILURE";

export const GET_TOP_ORDERED_FOODS_REQUEST = "GET_TOP_ORDERED_FOODS_REQUEST";
export const GET_TOP_ORDERED_FOODS_SUCCESS = "GET_TOP_ORDERED_FOODS_SUCCESS";
export const GET_TOP_ORDERED_FOODS_FAILURE = "GET_TOP_ORDERED_FOODS_FAILURE";
